# -*- coding: utf-8 -*-
#
# napari-error-dialogs documentation build configuration file, created by
...
project = u'napari-error-dialogs'
copyright = u'2015, DPS'
author = u'DPS'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-error-dialogs Documentation',
     [author], 1)
]
